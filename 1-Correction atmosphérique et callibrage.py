...
print(wfit.shape)
	...
	## --- A COMPLETER ---
	#Ouvrir le fichier .fits correspondant au spectre à corriger
filename = "AF708482_mono"
...
print(wfinal.shape)
        ...
        ## --- CORRECTION DE L'ATMO + FILTRES --- A COMPLETER
    #Utilisez la fonction AirmassCor pour corriger l'atmosphère
    #Tracez les spectres avant / après correction atmosphérique
...
# plot du spectre corrigé de la masse d'air et normalisé
plt.figure()
...
# enregistrement du spectre calibré spectralement, corrigé de la masse d'air et normalisé
